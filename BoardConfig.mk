...
TARGET_PREBUILT_KERNEL := device/samsung/beyondxq/prebuilt/Image-dtb
...
# Recovery
TARGET_OTA_ASSERT_DEVICE := beyondxq
BOARD_HAS_LARGE_FILESYSTEM := true
BOARD_HAS_NO_SELECT_BUTTON := true
TARGET_USERIMAGES_USE_EXT4 := true
TARGET_RECOVERY_FSTAB := device/samsung/beyondxq/recovery/root/etc/recovery.fstab
...
BOARD_PREBUILT_DTBOIMAGE := device/samsung/beyondxq/prebuilt/dtbo
